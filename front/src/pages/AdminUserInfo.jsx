...
export default function AdminUserInfo() {
  ...
  const handleDeleteUser = () => {
    if (
      window.confirm(
        `정말로 ${userDetailList[0]?.userName} 회원을 삭제하시겠습니까?\n\n이 작업은 되돌릴 수 없습니다.`
      )
    ) {
  ...
  const handleFarmClick = (farmIdx) => {
    const selectedFarm = userDetailList.find(
      (farm) => farm.farmIdx === farmIdx
    );
      ...
      <div className='inner inner_1080'>
        ...
        <div className='max-w-5xl mx-auto'>
          ...
          <div className='flex justify-end mb-4'>
            <button onClick={handleAddFarm} className='btn btn-primary'>
              농장 추가
            </button>
          </div>
            ...
            <div className='overflow-x-auto'>
              <table className='table'>
                ...
                <tbody>
                  ...
                  userDetailList.some((farm) => farm.farmName) ? (
                    userDetailList
